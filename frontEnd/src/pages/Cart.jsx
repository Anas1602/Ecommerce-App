...
const Cart = () => {
  const { products, currency, carItems, updateQty, navigate } =
          ...
          return (
            <div
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-5 mt-2">
                    ...
                    <p className="px-2 sm:px-3 border border-slate-200 rounded bg-slate-50">
                      {" "}
                      {item.size}{" "}
                    </p>
                  </div>
              ...
              <input
                ...
                className="border border-slate-200 rounded max-w-10 sm:max-w-20 px-1 sm:px-2 py-1"
              />
              <img
